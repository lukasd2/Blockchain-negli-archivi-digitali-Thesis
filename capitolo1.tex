...
Secondo gli analisti di STOA (Science and Technology Options Assessment), gruppo di ricerca del parlamento europeo, le blockchain potrebbero portare alla diffusione di organizzazioni autonome decentralizzate (DAO) governate dalla collettività. I potenziali sviluppi del un nuovo sistema di governance possono favorire la nascita di sistemi, organizzati non più gerarchicamente dall’alto verso il basso ma più democratici ed efficienti, dotati di utilità sociale che rispecchia direttamente i valori perseguiti dalla comunità\footfullcite{eu-parl-paper}.
