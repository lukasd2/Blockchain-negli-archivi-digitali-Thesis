...
Per contrastare le conseguenze negative derivanti dall’utilizzo di Proof of Work sono stati sviluppati oppure sono in produzione altri sistemi di consenso. Il perno della costruzione di questi sistemi riguarda proprio la fase di dimostrazione come descritta in Proof of Work. Tra i sistemi più promettenti è stato definito Proof of Stake che riesce a risolvere il problema del consumo di energia relativo alla quantità di calcoli computazionali.
