...
IPFS (InterPlanetary File System\footfullcite{ipfsWhitepaper}) è un progetto open-source i cui obiettivi vanno ben oltre l'offerta di un servizio di Storage distribuito. Lo scopo principale di IPFS è quello di costruire un file system globale distribuito basato su peer-to-peer.
